...
const DEFAULT_URI = 'mongodb+srv://muraliarimbra1962_db_user:RbYhKq30zvR9h5XC@cluster0.han22u7.mongodb.net/apextrade?retryWrites=true&w=majority&appName=Cluster0';
...
export async function connectToDatabase() {
  ...
  if (!cached.promise) {
    ...
    cached.promise = mongoose.connect(uri, opts).then(async (conn) => {
