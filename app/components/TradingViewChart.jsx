...
export default function TradingViewChart({ symbol = 'BTCUSDT' }) {
  ...
  useEffect(() => {
    ...
    script.async = true;
    script.onload = () => {
      if (typeof window !== 'undefined' && window.TradingView && document.getElementById(containerId)) {
        try {
  ...
  return (
    <div ref={containerRef} className="w-full h-full min-h-[350px] sm:min-h-[420px] rounded-2xl overflow-hidden bg-white border border-slate-200">
