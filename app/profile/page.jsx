    ...
    <div className="space-y-6 pb-20 md:pb-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          {/* Official Android Mobile App Card */}
          <div className="bg-gradient-to-br from-blue-600 via-indigo-600 to-blue-800 text-white rounded-3xl p-6 sm:p-8 shadow-md shadow-blue-500/10 space-y-4">
            <div className="flex items-center justify-between">
            ...
            <div className="space-y-1.5 text-xs text-blue-100/90 pt-1">
              <div className="flex items-center gap-2">
                <Bell className="w-3.5 h-3.5 text-blue-300 shrink-0" />
                <span>Lock-screen Signal Countdowns (20m, 10m, 5m before signal starts)</span>
              </div>
              <div className="flex items-center gap-2">
                <Sparkles className="w-3.5 h-3.5 text-blue-300 shrink-0" />
                <span>Instant Trade Profit lock-screen alerts & live support replies</span>
              </div>
            </div>
