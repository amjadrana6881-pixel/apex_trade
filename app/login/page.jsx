            ...
            <div className="space-y-2.5 pt-2">
              <div className="flex items-center gap-3 p-3 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xs">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-400">Strict high-probability setups with verified execution.</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-3 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xs">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-400">Live support desk with screenshot attachments.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-md w-full mx-auto space-y-4 sm:space-y-5">
            ...
            <div className="pt-0.5">
              ...
              <p className="text-xs text-slate-500 mt-0.5">
                Enter your registered credentials to access live desk.
              </p>
            </div>
            ...
            <div className="border-t border-slate-100 pt-3 text-center">
              <p className="text-xs text-slate-500">
                ...
                <Link href="/register" className="font-extrabold text-blue-600 hover:text-blue-700 hover:underline">
                  Create Free Account
                </Link>
              </p>
            </div>
