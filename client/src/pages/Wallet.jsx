  ...
  const handleSetWithdrawalPasswordSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setSetPasswordMsg('❌ ' + data.message);
      }
    } catch (err) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-7 bg-white border border-slate-200 rounded-3xl p-6 sm:p-7 shadow-xs space-y-6">
            <div>
              ...
              <p className="text-xs text-slate-500">Send USDT or BTC directly to the official platform depository address.</p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
              {depositWallets.map((w) => (
                ...
                >
                  ...
                  <span className="text-[10px] font-bold text-slate-400 truncate block">{w.network_name}</span>
                </button>
              ))}
            </div>
            ...
            {selectedWallet && (
              <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 sm:p-5 space-y-4">
                ...
                <div className="text-[11px] text-slate-500 space-y-1">
                  ...
                  <p>• Blockchain deposits automatically confirmed after minimum 1-3 network blocks.</p>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="lg:col-span-5 bg-white border border-slate-200 rounded-3xl p-6 sm:p-7 shadow-xs space-y-5">
            <div>
              ...
              <p className="text-xs text-slate-500">Provide deposit amount and Blockchain TXID hash for instant verification.</p>
            </div>
            ...
            <form onSubmit={handleDepositSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  required
                  placeholder="Paste your 64-char blockchain TXID"
                  value={depositTxid}
      ...
      {tab === 'withdraw' && (
        <div className="max-w-xl mx-auto bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-xs space-y-6">
          <div>
            ...
            <p className="text-xs text-slate-500">Withdrawals are processed strictly in USDT with 256-bit password security.</p>
          </div>
          ...
          <form onSubmit={handleWithdrawSubmit} className="space-y-4">
            ...
            {/* USDT Address (Auto-Saved / Pre-filled) */}
            <div>
              ...
              <label className="flex items-center gap-2 mt-2 cursor-pointer select-none">
                ...
                />
                <span className="text-xs text-slate-500">Save this USDT address as my default for future 1-click withdrawals</span>
              </label>
            </div>
